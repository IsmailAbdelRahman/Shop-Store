...
// بفرغ ماب وبسند كل محتوه فيها وحده لل صفات ال فوق
    ...
    this.message = josn['message'];
    this.data = josn['data']  != null  ?  USerData.formJosn(josn['data']) : null    ; // دي برضو عباره عن ماب عاوز افرغها واسندها لصفات بالتالي اعملها كلاس وحدها
