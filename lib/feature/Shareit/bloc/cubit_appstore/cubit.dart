...
///////////////////////////////
  ...
  uSerHome({String? tokin}) {
    ...
    return DioHelper.get(
            url: AppConstans.home, queryParameter: null, token: tokin)
        .then((value) {
      // print(value.data);
...
//////////////////////////////////////
  ...
  void getProfile() {
    DioHelper.get(url: AppConstans.getFavorites, token: AppConstans.tokin1)
        .then((value) {
